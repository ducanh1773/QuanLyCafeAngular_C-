...
export class SupplyCreateComponent implements OnInit {
    ...
    constructor(private stockService: StockService, private accountService: AccountService, private functService: FundService, private supplyService: SupplyService) { }
